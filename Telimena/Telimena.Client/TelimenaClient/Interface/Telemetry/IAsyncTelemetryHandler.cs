...
namespace TelimenaClient
{
    ...
    public interface IAsyncTelemetryHandler : IFluentInterface
    {
        ...
        /// <returns></returns>
        Task<TelemetryUpdateResponse> Event(string eventName, Dictionary<string, string> telemetryData = null);
        ...
        /// <returns></returns>
        Task<TelemetryUpdateResponse> View(string viewName, Dictionary<string, string> telemetryData = null);
    }
}
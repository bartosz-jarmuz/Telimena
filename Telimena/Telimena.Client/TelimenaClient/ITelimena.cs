...
namespace TelimenaClient
{
    ...
    public interface ITelimena
    {
        ...
        /// </summary>
        /// <returns></returns>
        Task<TelemetryInitializeResponse> InitializeAsync();
        ...
        /// </summary>
        /// <returns></returns>
        TelemetryInitializeResponse InitializeBlocking();
        ...
        /// <returns></returns>
        Task<TelemetryUpdateResponse> ReportUsageAsync([CallerMemberName] string viewName = null);
        ...
        /// <param name="viewName">The name of the view. If left blank, it will report the name of the invoked method</param>
        /// <returns></returns>
        TelemetryUpdateResponse ReportUsageBlocking([CallerMemberName] string viewName = null);
        ...
        /// <param name="viewName">The name of the view. If left blank, it will report the name of the invoked method</param>
        /// <returns></returns>
        Task<TelemetryUpdateResponse> ReportUsageWithCustomDataAsync(string customData, [CallerMemberName] string viewName = null);
        ...
        /// <param name="viewName">The name of the view. If left blank, it will report the name of the invoked method</param>
        /// <returns></returns>
        TelemetryUpdateResponse ReportUsageWithCustomDataBlocking(string customData, [CallerMemberName] string viewName = null);
        ...
        /// <param name="viewName">The name of the view. If left blank, it will report the name of the invoked method</param>
        /// <returns></returns>
        Task<TelemetryUpdateResponse> ReportUsageWithCustomDataAsync<T>(T customDataObject, [CallerMemberName] string viewName = null);
        ...
        /// <param name="viewName">The name of the view. If left blank, it will report the name of the invoked method</param>
        /// <returns></returns>
        TelemetryUpdateResponse ReportUsageWithCustomDataBlocking<T>(T customDataObject, [CallerMemberName] string viewName = null);
